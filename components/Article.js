...
const head = document.querySelector('.articles')
function articleMaker(obj) {
  ...
  article.appendChild(xSpan);


  article.classList.add('article');
  title.classList.add('title');
  xSpan.classList.add('expandButton')
